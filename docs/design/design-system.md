...
- Secondary : #C9A227 (accents, badges)
- Dark : #0F1411 (titres, contrastes)
- Light : #FFFFFF (cartes, zones claires)
- Muted : #7A8C7A (textes secondaires)
- Background : #FBF7F0 (fond global)
- Texte : #131A15
