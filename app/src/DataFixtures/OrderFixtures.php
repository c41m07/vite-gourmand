    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($this->getOrderDefinitions() as $definition) {
            ...
            foreach ($definition['menus'] as $menuDefinition) {
                $menu = $this->getReference($menuDefinition['menu'], \App\Entity\Menu::class);
            ...
            foreach ($definition['statusHistory'] as $historyDefinition) {
                ...
                if (isset($historyDefinition['changedBy'])) {
                    $changedBy = $this->getReference($historyDefinition['changedBy'], \App\Entity\User::class);
                }

                $history = (new CustomerOrderStatusHistory())
                    ->setCustomerOrder($order)
                    ->setOrderStatus($this->getReference($historyDefinition['status'], \App\Entity\OrderStatus::class))
        ...
        return [
            [
                ...
                'statusHistory' => [
                    ...
                    [
                        'status' => ReferenceFixtures::ORDER_STATUS_CONFIRMED,
            ...
            [
                ...
                'statusHistory' => [
                    ...
                    [
                        'status' => ReferenceFixtures::ORDER_STATUS_READY,
                        'changedAt' => new \DateTime('2026-03-07 17:45:00'),
                        'changedBy' => DemoUserFixtures::WORKER_REFERENCE,
                        'comment' => 'Commande prete pour la tournee du matin.',
                    ],
                ],
            ],
            [
